...
public class CreateNewTabDialog extends JDialog {
    ...
    public CreateNewTabDialog(MTSEditorGUI mtsEditorGUI, Point point) {
        ...
        textField.getDocument().addDocumentListener(new DocumentListener() {
            ...
            public void propertyChange() {
                ...
                if (textField.getText() != null && !Objects.equals(textField.getText(), "")
                    ...
                    if (!ElementHandler.getInstance().nameExists(textField.getText())) {
    ...
    private void onOK() {
        mtsEditorGUI.addNewTab(textField.getText(), point);
        dispose();
    }
